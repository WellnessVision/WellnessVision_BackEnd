...
public class NormalUser {
    ...
    public void invalidAddress1() {
        ...
        String sendFirstName = "Wasantha";
        String sendLastName = "Yapa";
        String sendEmail = "was@gmail.com";
        String sendPassword = "Inod@2000";
        String sendPasswordConfirm = "Inod@2000";
        String sendPhone = "0771234567";
        String sendAddress1 = "83/C@#$!()";
        ...
        try {
            By message = By.xpath("//h5[text()='Registration Successful. Thank you!']");
            wait.until(ExpectedConditions.visibilityOfElementLocated(message));
            System.out.println("Registration successful message appeared. Succeed with invalid address 1");
            driver.findElement(By.xpath("//button[contains(text(),'Thanks!')]")).click();
        } catch (TimeoutException e) {
            System.out.println("Registration successful message did not appear within the timeout.");
        }
    ...
    @Test
    public void withoutFillingAddress2() {
        driver.findElement(By.id("register_landing_page")).click();

        String sendFirstName = "Samantha";
        String sendLastName = "Silva";
        String sendEmail = "samantha@gmail.com";
        String sendPassword = "Inod@2000";
        String sendPasswordConfirm = "Inod@2000";
        String sendPhone = "0771234567";
        String sendAddress1 = "83/C";
...
//        address2.sendKeys(sendAddress2);
        ...
        try {
            By message = By.xpath("//h5[text()='Registration Successful. Thank you!']");
            wait.until(ExpectedConditions.visibilityOfElementLocated(message));
            System.out.println("Registration successful message appeared. Succeed without address 2");
            driver.findElement(By.xpath("//button[contains(text(),'Thanks!')]")).click();
        } catch (TimeoutException e) {
            System.out.println("Registration successful message did not appear within the timeout.");
        }
    ...
    public void invalidCity() {
        ...
        String sendFirstName = "Ruwanga";
        String sendLastName = "Konara";
        String sendEmail = "ruwanga@gmail.com";
        String sendPassword = "Inod@2000";
        String sendPasswordConfirm = "Inod@2000";
        String sendPhone = "0771234567";
        String sendAddress1 = "83/C";
        String sendAddress2 = "Meegalla";
        String sendCity = "Urapola@125*&~";
        String sendPostalCode = "11126";
        String sendPreferences = "diabetics";
        String sendProfilePic = "C:\\Users\\User\\Desktop\\profilePic.jpg";
        ...
        try {
            By message = By.xpath("//h5[text()='Registration Successful. Thank you!']");
            wait.until(ExpectedConditions.visibilityOfElementLocated(message));
            System.out.println("Registration successful message appeared. Succeed with invalid city name");
            driver.findElement(By.xpath("//button[contains(text(),'Thanks!')]")).click();
        } catch (TimeoutException e) {
            System.out.println("Registration successful message did not appear within the timeout.");
        }
    ...
    public void invalidPostalCode() {
        ...
        String sendFirstName = "Akmeemana";
        String sendLastName = "Dayarathana";
        String sendEmail = "akmee@gmail.com";
        String sendPassword = "Inod@2000";
        String sendPasswordConfirm = "Inod@2000";
        String sendPhone = "0771234567";
        String sendAddress1 = "83/C";
        String sendAddress2 = "Meegalla";
        String sendCity = "Urapola";
        String sendPostalCode = "111$Dayaa";
        String sendPreferences = "diabetics";
        String sendProfilePic = "C:\\Users\\User\\Desktop\\profilePic.jpg";
        ...
        try {
            By message = By.xpath("//h5[text()='Registration Successful. Thank you!']");
            wait.until(ExpectedConditions.visibilityOfElementLocated(message));
            System.out.println("Registration successful message appeared. Succeed with invalid postal code");
            driver.findElement(By.xpath("//button[contains(text(),'Thanks!')]")).click();
        } catch (TimeoutException e) {
            System.out.println("Registration successful message did not appear within the timeout.");
        }
